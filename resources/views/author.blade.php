...
<!-- Mirrored from noonpost.netlify.app/template/author by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 11:07:04 GMT -->
                ...
                <ul class="navbar-nav ml-auto mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu fade-up">
                            <li>
                                <a class="dropdown-item active" href="index">Demo 1</a>
                            </li>
                            <li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu fade-up">
                            ...
                            <li>
                                <a class="dropdown-item active" href="author"> author </a>
                            </li>
                            <li>
                    ...
                    <div class="card-columns">
                        ...
                        <div class="card">
                            <div class="post-card post-full">
                                <div class="post-card-image">
                                    <a href="post-default"><img src="assets/img/blog/27.jpg" alt=""></a>
                                </div>
                        ...
                        <div class="card">
                            <div class="post-card post-full">
                                ...
                                <div class="post-card-content">
                                    <a href="blog-grid" class="categorie">fashion</a>
                                    <h5>
