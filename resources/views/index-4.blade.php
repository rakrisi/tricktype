...
<!-- Mirrored from noonpost.netlify.app/template/index-4 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 11:03:39 GMT -->
                ...
                <ul class="navbar-nav ml-auto mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu fade-up">
                            ...
                            <li>
                                <a class="dropdown-item active" href="index-4">Demo 4 </a>
                            </li>
                            <li>
                     ...
                     <div class="row">
                         <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                            <div class="hero-content">
                                ...
                                <h2><a href="post-default">Top 10 Fashion Trends from Spring/Summer 2021 Fashion Weeks </a></h2>
                                <div class="post-card-info">
                                    <ul class="list-inline">
                                        <li><a href="author"><img src="assets/img/author/1.jpg" alt=""></a></li>
                                        <li><a href="author">David smith</a></li>
                                        <li class="dot"></li>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                            <div class="hero-content">
                                <a href="blog-grid" class="categorie">Travel</a>
                                <h2>
                                    <a href="post-default">Top 10 Forests That Every Nature Lover Must Visit</a>
                                </h2>
...
<!-- Mirrored from noonpost.netlify.app/template/index-4 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 11:04:51 GMT -->
<>