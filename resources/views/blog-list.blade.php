...
<!-- Mirrored from noonpost.netlify.app/template/blog-list by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 11:06:51 GMT -->
                ...
                <ul class="navbar-nav ml-auto mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu fade-up">
                            ...
                            <li>
                                <a class="dropdown-item active" href="blog-list"> Blog list </a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="post-card">
                                ...
                                <div class="post-card-content">
                                    <a href="blog-list" class="categorie">Travel</a>
                                    <h5>
