...
<!-- Mirrored from noonpost.netlify.app/template/post-default by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 11:06:51 GMT -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="main_nav">
                <ul class="navbar-nav ml-auto mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link  dropdown-toggle active" href="post-default" data-toggle="dropdown"> Posts Features </a>
                        <ul class="dropdown-menu fade-up">
                            <li>
                                <a class="dropdown-item active" href="post-default"> post default</a>
                            </li>
                            <li>
                            ...
                            <div class="widget">
                                <div class="widget-next-post">
                                    <div class="small-post">
                                        ...
                                        <div class="content">
                                            <div>
                                                <a class="link" href="post-default"><i class="arrow_left"></i>Preview post</a>
                                            </div>
                                            <a href="post-default">7 Healty Dinner Recipes for a Date Night at Home</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget">
                                <div class="widget-previous-post">
                                    <div class="small-post">
                                        ...
                                        <div class="content">
                                            <div>
                                                <a class="link" href="post-default">
                                                    <span> Next post</span>
                    ...
                    <div class="widget ">
                        ...
                        <ul class="widget-latest-posts">
                            <li class="last-post">
                                ...
                                <div class="nb">1</div>
                                <div class="content">
                                    <p><a href="post-default">5 Things I Wish I Knew Before Traveling to Malaysia</a></p>
...
<!-- Mirrored from noonpost.netlify.app/template/post-default by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Aug 2021 11:06:57 GMT -->
<>